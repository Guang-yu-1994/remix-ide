...
**WARNING:** It is a bad idea to use the Geth flag <b>--rpccorsdomain</b> with a wildcard: `--rpccorsdomain *`
...
To run Remix locally using a local test node, use this Geth command:
